...
const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
        const response = await axiosInstance.post('/admit-card', {
            ...formData,
            students: [], // খালি array পাঠানো হচ্ছে
            examData: {} // খালি object পাঠানো হচ্ছে
        });
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="flex items-center justify-between p-4 sm:p-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold text-gray-800">এডমিট কার্ড</h1>
          </div>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  />
                  <label
                    htmlFor="sendAttendanceSms"
                    className="flex items-center gap-2 text-sm font-medium text-gray-700 cursor-pointer"
                  >
                    <FaSms className="text-[#1e90c9]" />
                    Send attendance sms
                  </label>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                {formData.examId && (
                  <div className="mt-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <h4 className="text-sm font-medium text-[#1e90c9] mb-2">
                      নির্বাচিত পরীক্ষা
                    </h4>
                    <div className="text-sm text-blue-[#1e90c9]">
                      <p>
                        পরীক্ষার নাম:{" "}
                        {exams.find((e) => e._id === formData.examId)?.name}
                      </p>
                      <p>
                        পরীক্ষার ধরন:{" "}
                        {exams.find((e) => e._id === formData.examId)?.type ||
                          "N/A"}
                      </p>
                    </div>
                  </div>
