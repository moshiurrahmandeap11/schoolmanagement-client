            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                        Upload and manage circulars, notices, and documents for the institution
                    </p>
                </div>
                ...
                {stats && (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                        <div className="bg-white rounded-lg shadow-sm p-4 text-center">
                            <div className="text-2xl font-bold text-blue-600 mb-1">{stats.totalCirculars}</div>
                            <div className="text-sm text-gray-600">Total Circulars</div>
                        </div>
                        <div className="bg-white rounded-lg shadow-sm p-4 text-center">
                            <div className="text-2xl font-bold text-green-600 mb-1">{stats.activeCirculars}</div>
                            <div className="text-sm text-gray-600">Active</div>
                        </div>
                        <div className="bg-white rounded-lg shadow-sm p-4 text-center">
                            <div className="text-2xl font-bold text-purple-600 mb-1">{stats.totalDownloads}</div>
