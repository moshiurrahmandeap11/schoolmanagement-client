                ...
                <div className="mb-8">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div>
                            ...
                            <p className="text-gray-600 mt-2">আপনার এসএমএস ব্যালেন্স এবং ক্রয় ইতিহাস</p>
                        </div>
                        <button
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-white rounded-lg shadow-lg p-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-4 text-sm">
                                            <div className="text-center p-3 bg-blue-50 rounded-lg">
                                                <div className="text-lg font-semibold text-blue-700">{balance.totalSMS}</div>
                                                <div className="text-xs text-blue-600">ক্রয়কৃত</div>
                                            </div>
                                            <div className="text-center p-3 bg-green-50 rounded-lg">
                                                <div className="text-lg font-semibold text-green-700">{balance.usedSMS}</div>
                                                <div className="text-xs text-green-600">ব্যবহৃত</div>
                                            </div>
                                        </div>
                                ...
                                <button
                                    onClick={() => setShowBuyForm(true)}
                                    className="w-full mt-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors duration-200"
                                >
                                    আরও এসএমএস কিনুন
                                </button>
                            </div>
