...
import { FaPlus, FaEdit, FaTrash, FaSearch, FaDonate } from 'react-icons/fa';
      ...
      html: `
        <div class="text-left space-y-4">
          <div>
            ...
            <select id="editCategory" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
              ${categories.map(cat => 
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select id="editDonationType" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">মোট দাতা: <strong className="text-blue-600">{totalDonors}</strong></p>
          </div>
          <button
