...
const AddNewStudentAttendanceShift = ({ onBack, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axiosInstance.post('/smart-attendance-shift', formData);

            if (response.data && response.data.success) {
                setSuccess('শিফট সফলভাবে সংরক্ষণ করা হয়েছে');
                setTimeout(() => {
                    onSuccess();
                }, 2000);
            } else {
...
export default AddNewStudentAttendanceShift;