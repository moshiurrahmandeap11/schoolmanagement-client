...
const AddNewSection = ({ onBack, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                showSweetAlert('success', 'সেকশন সফলভাবে তৈরি হয়েছে!');
                if (onSuccess) {
                    onSuccess();
                }
                onBack();
            } else {
                showSweetAlert('error', response.data.message || 'সেকশন তৈরি করতে সমস্যা হয়েছে');
            }
        } catch (error) {
            console.error('Error creating section:', error);
            const errorMessage = error.response?.data?.message || 'সেকশন তৈরি করতে সমস্যা হয়েছে';
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            ...
                            <div className="flex gap-4 pt-4">
                                ...
                                >
                                    ...
                                    {loading ? 'সেভ হচ্ছে...' : 'সেকশন সেভ করুন'}
                                </button>
                            </div>
                        </div>
                    </form>
