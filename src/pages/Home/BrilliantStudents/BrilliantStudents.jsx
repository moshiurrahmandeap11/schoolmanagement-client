  ...
  const fetchStudents = async () => {
    try {
      ...
      if (response.data && response.data.success) {
        ...
        const brilliantStudents = allStudents.filter((student) => {
          const roll = student.classRoll;
          console.log(
            `Student: ${
              student.name
            }, Roll: ${roll}, Type: ${typeof roll}, Status: ${student.status}`
          ); // Debugging line
        ...
        const errorMsg =
          response.data?.message || "Failed to load data from server";
        setError(errorMsg);
      ...
      setError(
        "Failed to load brilliant students. Please check your connection and try again."
      );
    } finally {
      setLoading(false);
    }
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800 mb-2">
              No Brilliant Students Found
            </h3>
            <p className="text-gray-600 mb-4">
              No students with roll 1 or 2 found in active status.
            </p>
            <button
              onClick={fetchStudents}
        ...
        >
          <div className="flex gap-4 sm:gap-6" style={{ width: "max-content" }}>
            {infiniteStudents.map((student, index) => {
              ...
              // Fix: Properly handle class object
              let className = "N/A";
              if (student.class) {
                ...
                >
                  ...
                  <div className="relative h-52 sm:h-64 bg-linear-to-br from-blue-50 to-indigo-100">
                    ...
                    <div className="absolute top-2 left-2">
                      <span
                        className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-bold ${rankBadge.color} text-white shadow-lg`}
                      >
