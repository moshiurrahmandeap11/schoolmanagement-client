    ...
    if (error || !historyData) {
        return (
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">No History Available</h3>
                <p className="text-gray-600">School history information will be added soon.</p>
            </div>
        );
    }
    ...
    {historyData.title}
            ...
            <div className="px-3 pb-2">
                ...
                <button
                    ...
                    className="inline-flex items-center px-4 py-2 bg-[#E6F9FD] text-blue-600 font-medium rounded-full cursor-pointer shadow-md "
                >
                    <span> আরো জানুন...</span>
                </button>
            </div>
