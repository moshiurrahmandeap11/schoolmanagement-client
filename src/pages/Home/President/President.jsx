...
const President = () => {
    ...
    const fetchSpeech = async () => {
        try {
            ...
            if (response.data.success) {
                const presidentSpeech = response.data.data.find(s => s.type === 'president' && s.isActive);
                setSpeech(presidentSpeech);
            }
        } catch (error) {
            console.error('Error fetching president speech:', error);
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleReadMore = () => {
        if (speech?._id) {
            navigate(`/president-speech/${speech._id}`);
        }
    };
        ...
        return (
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 text-lg">সভাপতির বাণী এখনো যুক্ত করা হয়নি</p>
