...
import { FaCalendarAlt, FaClock, FaArrowLeft, FaHistory } from 'react-icons/fa';
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center py-12">
                <div className="text-center max-w-md mx-auto px-4">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 mb-3">History Not Found</h2>
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center py-12">
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-gray-800 mb-3">No History Data Found</h2>
                    <button
                        onClick={handleGoBack}
        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 py-8">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex flex-wrap items-center gap-6 text-gray-600">
                                <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-full">
                                    ...
                                    <span className="text-sm font-medium">Created: {formatDate(historyData.createdAt)}</span>
                                </div>
                                <div className="flex items-center gap-2 bg-green-50 px-4 py-2 rounded-full">
                                    <FaClock className="w-4 h-4 text-green-600" />
                                    <span className="text-sm font-medium">Time: {formatTime(historyData.createdAt)}</span>
                                </div>
                                {historyData.updatedAt !== historyData.createdAt && (
                                    <div className="flex items-center gap-2 bg-purple-50 px-4 py-2 rounded-full">
                                        <FaClock className="w-4 h-4 text-purple-600" />
                                        <span className="text-sm font-medium">Updated: {formatDate(historyData.updatedAt)}</span>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="mt-12 pt-8 border-t border-gray-200">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                                <div className="text-sm text-gray-500">
                                    <p className="font-medium">History ID: <span className="font-mono text-gray-700">{historyData._id}</span></p>
                                </div>
                                <div className="text-sm text-gray-500">
                                    <p>Last modified: {formatDate(historyData.updatedAt)} at {formatTime(historyData.updatedAt)}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-12 text-center">
                    <button
                        onClick={handleGoBack}
                        className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-2xl hover:from-blue-700 hover:to-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-500/30 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                    >
            ...
            <style jsx>{`
                ...
                .history-content h3 { font-size: 1.75rem; }
                .history-content h4 { font-size: 1.5rem; }
                .history-content h5 { font-size: 1.25rem; }
                .history-content h6 { font-size: 1.125rem; }
